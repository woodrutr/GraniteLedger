...
import graniteledger.src.models.electricity.scripts.preprocessor as prep
import graniteledger.src.models.electricity.scripts.postprocessor as post
from graniteledger.src.models.electricity.scripts.utilities import check_results
...
from graniteledger.src.integrator.utilities import select_solver
...
# Establish paths
data_root = Path(
    PROJECT_ROOT, 'graniteledger', 'src', 'models', 'electricity', 'input'
)
...
def build_elec_model(frames, setin) -> PowerModel:
    ...
    Parameters
    ----------
    frames : graniteledger.io_loader.Frames or mapping of str to pandas.DataFrame
        input data frames
    setin : Sets
        input settings Sets
