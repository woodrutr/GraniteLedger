...
from graniteledger.dispatch.lp_network import solve_from_frames as solve_network_from_frames
from graniteledger.dispatch.lp_single import solve as solve_single
from graniteledger.engine.outputs import EngineOutputs
...
def _ensure_pandas() -> None:
    ...
    if pd is None:  # pragma: no cover - helper exercised indirectly
        raise ImportError(
            "pandas is required for graniteledger.engine.run_loop; install it with `pip install pandas`."
        )
