...
### Support
Please check out the Frequently Asked Questions (FAQ) section in GitHub for helpful resources. Please reach out to BlueSky team for assistance: nextgenerationmodel@eia.gov  

### Contributing and Feedback

Contributions to BlueSky are governed by [specific rules](https://github.com/eiagov). You can direct questions about the BlueSky model to nextgenerationmodel@eia.gov. 

We are looking for feedback on the code implementation for the BlueSky Prototype. At this time, we do not need feedback on energy market and policy representations. You may provide feedback by emailing nextgenerationmodel@eia.gov and answering the following questions:
...
3.	Is this code nimble and flexible enough to code up the next-generation of energy models?
