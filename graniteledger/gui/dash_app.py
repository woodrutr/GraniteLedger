...
from graniteledger.main import app_main
from graniteledger.src.models.electricity.scripts.technology_metadata import (
...
def auto_load_toml(selected_mode):
    ...
    """
    config_template_path = Path(PROJECT_ROOT, 'graniteledger', 'src', 'common', 'run_config_template.toml')
    config_file_path = Path(PROJECT_ROOT, 'graniteledger', 'src', 'common', 'run_config.toml')
...
def save_toml(
    ...
    -------
        empty string
    """
    config_template = os.path.join(PROJECT_ROOT, 'graniteledger', 'src', 'common', 'run_config_template.toml')
    config_file_path = os.path.join(PROJECT_ROOT, 'graniteledger', 'src', 'common', 'run_config.toml')
