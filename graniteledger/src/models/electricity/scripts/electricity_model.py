...
from graniteledger.src.integrator.utilities import HI
from graniteledger.src.common.model import Model

# move to new file
from graniteledger.src.models.electricity.scripts.utilities import ElectricityMethods as em
...
class PowerModel(Model):
    ...
    Parameters
    ----------
    all_frames : graniteledger.io_loader.Frames or mapping of str to pandas.DataFrame
